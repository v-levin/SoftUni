    ...
    public class StartUp
    {
        ...
        public static void Main()
        {
            ...
            while ((input = Console.ReadLine()) != "End")
            {
                ...
                {
                    case "Private":
                        army.Add(new Private(int.Parse(args[1]), args[2], args[3], decimal.Parse(args[4])));
                        break;
                    case "Spy":
                    ...
                    case "LeutenantGeneral":
                        ...
                        army.Add(new LeutenantGeneral(int.Parse(args[1]), args[2], args[3], decimal.Parse(args[4]), privates));
                        break;
                    case "Commando":
                        ...
                        army.Add(new Commando(int.Parse(args[1]), args[2], args[3], decimal.Parse(args[4]), args[5], missions));
                        break;
                    case "Engineer":
                        if (args[5] != "Airforces" && args[5] != "Marines")
                        {
                        ...
                        army.Add(new Engineer(int.Parse(args[1]), args[2], args[3], decimal.Parse(args[4]), args[5], parts));
                        break;
                }
            }
        ...
        private static IList<ISoldier> ExtractPrivates(IList<string> soldiers)
        {
            ...
            {
                list.Add(army.First(s => s.Id == int.Parse(soldier)));
            }
